...
public class ParametersNames {
    ...
    public static String ATTENDING_TIME_KEY = "attending_time";
    ...
    public static String BEHAVIOUR_SCHEME_KEY = "behaviour_scheme";
    public static String MIN_RADIUS_KEY = "min_radius";
    public static String MAX_RADIUS_KEY = "max_radius";
    public static String MAX_VELOCITY_KEY = "max_velocity";
    public static String FREQUENCY_KEY = "frequency";
    public static String MIN_AGENTS_KEY = "min_agents";
    public static String MAX_AGENTS_KEY = "max_agents";
}
